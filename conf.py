...
BLOG_AUTHOR = "Michael Becker"  # (translatable)
BLOG_TITLE = "beckerfuffle"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://beckerfuffle.com/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://beckerfuffle.com/"
BLOG_EMAIL = "mike@beckerfuffle.com"
BLOG_DESCRIPTION = "Untangling the AI kerfuffle, one Becker at a time."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "mdbecker/blog"
...
GLOBAL_CONTEXT = {
    'utterances_config': {
        # Match pages to issues by pathname, eg /posts/my-post/
        "issue-term": "pathname",

        # Nice default: picks light/dark based on user’s theme
        "theme": "preferred-color-scheme",

        # Optional label for comment issues in GitHub
        "label": "comments",

        # Standard crossorigin option
